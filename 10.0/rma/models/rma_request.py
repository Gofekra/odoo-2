...
class RmaReuqest(models.Model):
    ...
    def create(self, vals):
        ...
        return super(RmaReuqest, self).create(vals)
    ...
    def _track_subtype(self, init_values):
        ...
        return super(RmaReuqest, self)._track_subtype(init_values)
        ...
        for request in self:
            if request.state != 'draft':
                raise UserError(_(
                    ...
                    'state.'))
        return super(RmaReuqest, self).unlink()
