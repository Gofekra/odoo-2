    ...
    def _register_hook(self):
        ...
        def fields_view_get(self, view_id=None, view_type='form',  toolbar=False, submenu=False):
            ...
            def raise_view_error(error_msg, child_view_id):
                view, child_view = self.env['ir.ui.view'].sudo().browse([view_id, child_view_id])
            ...
            def apply_view_inheritance( source, inherit_id):
                ...
                """
                sql_inherit = self.env['ir.ui.view'].sudo().get_inheriting_views_arch( inherit_id, self._name,)
            ...
            if parent_view_model != BaseModel._name:
                ...
                ctx = context
            xarch, xfields=self.env['ir.ui.view'].sudo().postprocess_and_fields( self._name, result['arch'], view_id)
            result['arch'] = xarch
            ...
            if toolbar:
                ...
                resprint = IrValues.sudo().get_actions('client_print_multi', self._name)
                resaction = IrValues.sudo().get_actions('client_action_multi', self._name)
                resrelate = IrValues.sudo().get_actions('client_action_relate', self._name)
