...
class RestAPI(http.Controller):
    ...
    @http.route([ '/api/user/get_token', ], auth="public", website=True, methods=['GET'])
    ...
    @http.route([ '/api/user/delete_token',], auth="public", website=True, methods=['GET'])
    ...
    @http.route(['/api/user/refresh_token', ], auth="public", website=True, methods=['GET'])
    ...
    @http.route(['/api/<string:model>/search', '/api/<string:model>/search/<int:id>' ], type='http', auth="public")
    ...
    @http.route(['/api/<string:model>/create' ], type='http', auth="public", csrf=False)
    ...
    @http.route(['/api/<string:model>/update','/api/<string:model>/update/<int:id>'], type='http', auth="public", csrf=False)
    ...
    @http.route(['/api/<string:model>/unlink/','/api/<string:model>/unlink/<int:id>'], type='http', auth="public", csrf=False)
    ...
    @http.route(['/api/<string:model>/<int:id>/method/<string:method_name>'], type='http', auth="public")
