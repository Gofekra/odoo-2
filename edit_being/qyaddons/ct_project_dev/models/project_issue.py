...
class ProjectIssue(models.Model):
    ...
    #task_id = fields.Many2one('project.task', string='Related task', translated=True)
    technical_name = fields.Char(string='Technical name', related='task_id.technical_name', translated=True, readonly=True)
    ...
    reopen_description = fields.Html(string='Re-opening Description', translated=True)
    fixing_description = fields.Html(string='Fixing description', translated=True)
    verification_description = fields.Html(string='Verification description', translated=True)
    closing_description = fields.Html(string='Closing description', translated=True)
    cancellation_description = fields.Html(string='Cancellation description', translated=True)
