...
class UfWorkLine(models.Model):
    ...
    #self.env['ir.sequence'].get('uf.work.line') or '1000')
    ...
    #line_ids = fields.One2many('uf.work.line.line', 'tpl_id', 'Lines')
    ...
    def do_print(self, cr, uid, ids, context=None):
        ...
        return self.pool['report'].get_action(cr, uid, ids, 'ct_project_uf.uf_work_line_report', context=context)
    ...
    def do_preview(self, context=None):
        ...
        return {
            ...
            'url': '/report/html/ct_project_uf.uf_work_line_report/'+str(self.ids[0]),
            'target': 'new',
        }
