...
class UfLogPrint(models.Model):
    ...
    #self.env['ir.sequence'].get('uf.log.print') or '1000')
    ...
    #line_ids = fields.One2many('uf.log.print.line', 'tpl_id', 'Lines')
    ...
    def do_preview(self, context=None):
        ...
        return {
            'name': 'action_uf_log_print_report',
