...
class UfWorkTpl(models.Model):
    ...
    #self.env['ir.sequence'].get('uf.work.tpl') or '1000')
    ...
    #line_ids = fields.One2many('uf.work.tpl.line', 'tpl_id', 'Lines')
    ...
    def do_print(self, cr, uid, ids, context=None):
        ...
        return self.pool['report'].get_action(cr, uid, ids, 'ct_project_uf.uf_work_tpl_report', context=context)
    ...
    def do_preview(self, context=None):
        ...
        return {
            ...
            'url': '/report/html/ct_project_uf.uf_work_tpl_report/'+str(self.ids[0]),
            'target': 'new',
        }
