...
exports.Orderline = Backbone.Model.extend({
    ...
    get_base_price:function(){
        ...
        return round_pr(this.get_unit_price() * this.get_quantity() * ((this.get_discount()/100)||1), rounding);
    ...
    get_all_prices: function(){
        var price_unit = this.get_unit_price() * ((this.get_discount() / 100)||1);
        var taxtotal = 0;
...
exports.Order = Backbone.Model.extend({
    ...
    get_total_discount: function() {
        return round_pr(this.orderlines.reduce((function(sum, orderLine) {
            return sum + (orderLine.get_unit_price() * (1-((orderLine.get_discount()/100) || 1)) * orderLine.get_quantity());
        }), 0), this.pos.currency.rounding);
    },
