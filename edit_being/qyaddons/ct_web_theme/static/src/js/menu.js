...
var Menu = Widget.extend({
    template: 'Menu',
    events: {
        'touchmove .o_menu_sections':function(ev){
            ev.stopPropagation();
        },
    ...
    //新增代码
        ...
        AppSwitcher = this.$el.find(".o_main_navbar");
        ...
        function touch (event){  
            ...
            if(!AppSwitcher.find(".o_menu_sections").children().length){
            ...
            switch(event.type){
                ...
                case "touchstart":
                    ...
                    client = event.touches[0].clientY;
                ...
                case "touchmove":
                    ...
                    if(offset<client){
                        ...
                        AppSwitcher.addClass('active');
                    }else{
                        AppSwitcher.filter(".active").removeClass('active');
                    }
    ...
    topMenClick:function(element){

    //新增代码
    var _self = this;

    _self.$el.find(element).on('click',function(e){

        if($(this).parent().is(".dropdown-menu")){

            $(this).parent(".dropdown-menu").parent("li").addClass('act').siblings().filter('.act').removeClass('act');
        }else{

            $(this).addClass('act').siblings().filter('.act').removeClass('act');
        }


    }).first().addClass('act').siblings().filter('.act').removeClass('act');
    ...
    change_menu_section: function (primary_menu_id) {
        ...
        //新增代码
        this.topMenClick(".o_menu_sections li:not(:has(ul))");
