...
var indisable = {
    "ct_dxb_home.ct_theme_default":{title:"默认风格",appath:"icon/"},
    "ct_dxb_home.ct_theme_blue":{title:"蓝色风格",appath:"theme/blue/icon/"},
    "ct_dxb_home.ct_theme_palm":{title:"棕色风格",appath:"theme/palm/icon/"},
    "ct_dxb_home.ct_theme_deepblue":{title:"深蓝风格",appath:"theme/deepblue/icon/"},
    "ct_dxb_home.ct_theme_green":{title:"深蓝风格",appath:"theme/green/icon/"}
}
